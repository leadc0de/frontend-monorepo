...
import {type TableFilterProps, TableHeadCustomFilterProps, type TableHeadProps} from './table'
import {type MenuItemProps} from '../menu/menu-item'
import {IconAwesomeEnum} from '@leadcode/enums'
import {classNames, upperCaseFirstLetter} from '@leadcode/utils'
import { Icon } from '../icons/icon'
import { Button, ButtonSize, ButtonStyle } from '../buttons'
      ...
      contentLeft: (
        <Icon
          ...
          className={classNames(
            'text-sm', currentFilter === item ? 'text-green-400' : 'text-transparent'
          )}
        />
      ),
      onClick: () => {
